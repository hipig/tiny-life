...
func setup(room: Dictionary) -> void:
	...
	if tenant_id.is_empty():
		AssetResolver.apply_asset_to_texture_rect(icon, UIPanelFactory.icon_asset("Package.png"), Vector2i(16, 16))
		...
		AssetResolver.apply_asset_to_texture_rect(icon, UIPanelFactory.icon_asset("Properties.png"), Vector2i(16, 16))
