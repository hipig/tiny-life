...
func test_ui_scenes_are_editor_authored_for_360_viewport() -> void:
	...
	assert_true(room_panel_scene.contains("WallpaperListRoot"), "RoomPanel should expose a wallpaper list root")
	assert_true(room_panel_scene.contains("WallListRoot"), "RoomPanel should expose a wall-style list root")
	assert_true(room_panel_scene.contains("DoorListRoot"), "RoomPanel should expose a door-style list root")
