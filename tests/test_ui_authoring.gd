...
func test_ui_scenes_are_editor_authored_for_360_viewport() -> void:
	...
	assert_true(room_panel_scene.contains("DecorCategoryRow"), "RoomPanel should expose decor category filters")
	assert_true(room_panel_scene.contains("WallpaperDecorFilter"), "RoomPanel should expose a wallpaper decor filter")
	assert_true(room_panel_scene.contains("WallDecorFilter"), "RoomPanel should expose a wall decor filter")
	assert_true(room_panel_scene.contains("DoorDecorFilter"), "RoomPanel should expose a door decor filter")
	assert_true(room_panel_scene.contains("DecorListRoot"), "RoomPanel should expose a single filtered decor list root")
	assert_true(room_panel_scene.contains("metadata/tab_id = \"wallpaper\""), "RoomPanel wallpaper filter should be scene-keyed")
	assert_true(room_panel_scene.contains("metadata/tab_id = \"wall\""), "RoomPanel wall filter should be scene-keyed")
	assert_true(room_panel_scene.contains("metadata/tab_id = \"door\""), "RoomPanel door filter should be scene-keyed")
	...
	assert_true(room_panel_source.contains("ROOM_DECOR_ITEM_ROW_SCENE"), "RoomPanel should render decor items through a reusable row scene")
