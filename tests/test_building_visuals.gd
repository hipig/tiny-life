...
func test_building_traffic_scenes_support_short_away_routes() -> void:
	...
	assert_true(apartment_source.contains("@onready var apartment_roof: ApartmentRoof = $ApartmentRoof"), "ApartmentBuilding should own one building-level roof node")
	assert_true(apartment_source.contains("apartment_roof.apply_layout(ConfigManager.apartment_roof_theme())"), "ApartmentBuilding should render the global apartment roof from config")
